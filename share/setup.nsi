...
VIAddVersionKey ProductName "Zenzo Core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\zenzo-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Zenzo Core (testnet, -bit).lnk" "$INSTDIR\zenzo-qt" "-testnet" "$INSTDIR\zenzo-qt" 1
    ...
    WriteRegStr HKCR "zenzo" "URL Protocol" ""
    WriteRegStr HKCR "zenzo" "" "URL:Zenzo"
    WriteRegStr HKCR "zenzo\DefaultIcon" "" $INSTDIR\zenzo-qt
    WriteRegStr HKCR "zenzo\shell\open\command" "" '"$INSTDIR\zenzo-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\zenzo-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Zenzo Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\Zenzo.lnk"
