...
pkgdatadir = $(datadir)/zenzo
pkgincludedir = $(includedir)/zenzo
pkglibdir = $(libdir)/zenzo
pkglibexecdir = $(libexecdir)/zenzo
...
CONFIG_HEADER = $(top_builddir)/src/config/zenzo-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/zenzo-config.h.in \
...
ACLOCAL = ${SHELL} /home/kittie/ZENZO-Core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/kittie/ZENZO-Core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/kittie/ZENZO-Core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/kittie/ZENZO-Core/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = zenzo-cli
BITCOIN_DAEMON_NAME = zenzod
BITCOIN_GUI_NAME = zenzo-qt
BITCOIN_TX_NAME = zenzo-tx
...
CPPFLAGS = -I/home/kittie/ZENZO-Core/db4/include/ -DBOOST_SPIRIT_THREADSAFE -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -DHAVE_QT5
CRYPTO_CFLAGS = 
CRYPTO_LIBS = -lcrypto
CXX = g++ -std=c++11
CXXCPP = g++ -std=c++11 -E
...
LDFLAGS = -L/home/kittie/ZENZO-Core/db4/lib/  -Wl,-z,relro -Wl,-z,now
LEVELDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/kittie/ZENZO-Core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
PACKAGE_STRING = Zenzo Core 1.2.0
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/kittie/ZENZO-Core
abs_srcdir = /home/kittie/ZENZO-Core
abs_top_builddir = /home/kittie/ZENZO-Core
abs_top_srcdir = /home/kittie/ZENZO-Core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/kittie/ZENZO-Core/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_zenzo_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_zenzo_coverage.info test_zenzo.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Zenzo-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/zenzo-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/zenzo-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/zenzo-config.h
$(top_srcdir)/src/config/zenzo-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/zenzo-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Zenzo-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Zenzo-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Zenzo-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_zenzo.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_zenzo -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_zenzo_filtered.info: test_zenzo.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_zenzo_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_zenzo_coverage.info: baseline_filtered_combined.info test_zenzo_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_zenzo_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_zenzo_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_zenzo_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_zenzo.coverage/.dirstamp:  test_zenzo_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_zenzo.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_zenzo.coverage/ total.coverage/ $(OSX_APP)
