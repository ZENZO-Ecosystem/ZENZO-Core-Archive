...
TRANSLATIONS += src/qt/locale/zenzo_bg.ts \
                src/qt/locale/zenzo_de.ts \
                src/qt/locale/zenzo_en.ts \
                src/qt/locale/zenzo_es.ts \
                src/qt/locale/zenzo_fi.ts \
                src/qt/locale/zenzo_fr.ts \
                src/qt/locale/zenzo_it.ts \
                src/qt/locale/zenzo_ja.ts \
                src/qt/locale/zenzo_pl.ts \
                src/qt/locale/zenzo_pt.ts \
                src/qt/locale/zenzo_ru.ts \
                src/qt/locale/zenzo_sk.ts \
                src/qt/locale/zenzo_sv.ts \
                src/qt/locale/zenzo_vi.ts \
                src/qt/locale/zenzo_zh_CN.ts \
                src/qt/locale/zenzo_zh_TW.ts
