...
The following applies to code changes to the Zenzo Core project, and is not to be
confused with overall Zenzo Network Protocol consensus changes.

Whether a pull request is merged into Zenzo Core rests with the project merge
...
Patches that change Zenzo consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zenzo consensus, it must have been
...
The project leader is the release manager for each Zenzo Core release.
