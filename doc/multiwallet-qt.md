...
In order to support loading of multiple wallets in zenzo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zenzo.cpp.
...
Changes to zenzo.cpp
----------------------
zenzo.cpp is the entry point into zenzo-qt, and as such, will require some minor modifications to provide hooks for
