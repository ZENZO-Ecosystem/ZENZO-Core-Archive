...
{
    throw runtime_error("Obfuscation and Zerocoin are not supported any more.\n");

    if (fHelp || params.size() == 0)
        throw runtime_error(
            "obfuscation <zenzoaddress> <amount>\n"
            "zenzoaddress, reset, or auto (AutoDenominate)"
    ...
    if (params.size() != 2)
        throw runtime_error(
            "obfuscation <zenzoaddress> <amount>\n"
            "zenzoaddress, denominate, or auto (AutoDenominate)"
            "<amount> is a real and will be rounded to the next 0.1" +
            HelpRequiringPassphrase());
...
Value masternode(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  start        - Start masternode configured in zenzo.conf\n"
...
Value masternodeconnect(const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 1))
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("masternodeconnect", "\"192.168.0.6:26210\"") + HelpExampleRpc("masternodeconnect", "\"192.168.0.6:5510\""));
