...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        palette.setBrush(QPalette::Active, QPalette::Text, brush7);
        ...
        QBrush brush17(QColor(197, 243, 187, 255));
        brush17.setStyle(Qt::SolidPattern);
        palette1.setBrush(QPalette::Active, QPalette::AlternateBase, brush17);
        QBrush brush18(QColor(125, 194, 122, 255));
        ...
        palette1.setBrush(QPalette::Active, QPalette::Text, brush19);
        ...
        palette1.setBrush(QPalette::Inactive, QPalette::Text, brush20);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The ZENZO address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the ZENZO: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the ZENZO network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
