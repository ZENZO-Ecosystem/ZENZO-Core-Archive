...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountPiv->setText(QApplication::translate("DashboardWidget", "TextLabel", Q_NULLPTR));
        labelAmountZpiv->setText(QApplication::translate("DashboardWidget", "TextLabel", Q_NULLPTR));
        labelChart->setText(QApplication::translate("DashboardWidget", "Staking statistics", Q_NULLPTR));
        labelSquarePiv->setText(QString());
        labelPiv->setText(QApplication::translate("DashboardWidget", "PIV", Q_NULLPTR));
        labelSquarezPiv->setText(QString());
        labelZpiv->setText(QApplication::translate("DashboardWidget", "zPIV", Q_NULLPTR));
