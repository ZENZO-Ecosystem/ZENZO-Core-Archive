...
public:
    ...
    QLabel *labelTitle2;
    QLabel *labelAmountzPiv;
    QHBoxLayout *horizontalLayout;
    QVBoxLayout *verticalLayout_5;
    QLabel *labelTitle5;
    QLabel *labelPendingzPiv;
    QSpacerItem *horizontalSpacer_4;
    QVBoxLayout *verticalLayout_6;
    QLabel *labelTitle6;
    QLabel *labelImmaturezPiv;
...
"border:none;"));
        ...
        labelAmountTopzPiv = new QLabel(widgetTopAmount);
        labelAmountTopzPiv->setObjectName(QStringLiteral("labelAmountTopzPiv"));
        labelAmountTopzPiv->setMinimumSize(QSize(0, 36));

        horizontalLayout_5->addWidget(labelAmountTopzPiv, 0, Qt::AlignTop);
...
"border:none;"));
        ...
        labelAmountzPiv = new QLabel(bottom_container);
        labelAmountzPiv->setObjectName(QStringLiteral("labelAmountzPiv"));

        verticalLayout->addWidget(labelAmountzPiv);
        ...
        labelPendingzPiv = new QLabel(bottom_container);
        labelPendingzPiv->setObjectName(QStringLiteral("labelPendingzPiv"));

        verticalLayout_5->addWidget(labelPendingzPiv);
        ...
        labelImmaturezPiv = new QLabel(bottom_container);
        labelImmaturezPiv->setObjectName(QStringLiteral("labelImmaturezPiv"));

        verticalLayout_6->addWidget(labelImmaturezPiv);
    ...
    void retranslateUi(QWidget *TopBar)
    {
        ...
        labelAmountTopPiv->setText(QApplication::translate("TopBar", "480.0685 PIV", Q_NULLPTR));
        label_16->setText(QString());
        labelAmountTopzPiv->setText(QApplication::translate("TopBar", "1,000 zPIV", Q_NULLPTR));
        labelTitle1->setText(QApplication::translate("TopBar", "Available", Q_NULLPTR));
        labelAmountPiv->setText(QApplication::translate("TopBar", "480.0685 PIV", Q_NULLPTR));
        labelTitle3->setText(QApplication::translate("TopBar", "Pending", Q_NULLPTR));
        labelPendingPiv->setText(QApplication::translate("TopBar", "6.943 PIV", Q_NULLPTR));
        labelTitle4->setText(QApplication::translate("TopBar", "Immature", Q_NULLPTR));
        labelImmaturePiv->setText(QApplication::translate("TopBar", "10 PIV", Q_NULLPTR));
        label_9->setText(QString());
        labelTitle2->setText(QApplication::translate("TopBar", "Available", Q_NULLPTR));
        labelAmountzPiv->setText(QApplication::translate("TopBar", "1,000 zPIV", Q_NULLPTR));
        labelTitle5->setText(QApplication::translate("TopBar", "Pending", Q_NULLPTR));
        labelPendingzPiv->setText(QApplication::translate("TopBar", "60 zPIV", Q_NULLPTR));
        labelTitle6->setText(QApplication::translate("TopBar", "Immature", Q_NULLPTR));
        labelImmaturezPiv->setText(QApplication::translate("TopBar", "10 zPIV", Q_NULLPTR));
