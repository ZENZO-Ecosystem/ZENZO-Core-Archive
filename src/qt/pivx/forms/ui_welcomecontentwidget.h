...
"PIVX Core Wallet", Q_NULLPTR));
        labelMessage2->setText(QApplication::translate("WelcomeContentWidget", "PIVX is the world\342\200\231s most advanced privacy-enabled Proof of Stake blockchain technology, all developed by a team of highly experienced developers and cryptographers.", Q_NULLPTR));
        labelTitle3->setText(QApplication::translate("WelcomeContentWidget", "How PIVX respects your privacy?", Q_NULLPTR));
        labelMessage3->setText(QApplication::translate("WelcomeContentWidget", "<html><head/><body><p>As our manifesto says: Privacy is a non-negotiable basic human right; it grants users the freedom the share their data whenever and with whomever they want - PIVX believes in self sovereignty</p></body></html>", Q_NULLPTR));
        labelTitle4->setText(QApplication::translate("WelcomeContentWidget", "What is a Masternode?", Q_NULLPTR));
        labelMessage4->setText(QApplication::translate("WelcomeContentWidget", "The masternode network is PIVX's second layer network on top of the blockchain that enables our DAO to provide decentralized governance, treasury, and SwiftX transactions.", Q_NULLPTR));
    } // retranslateUi
