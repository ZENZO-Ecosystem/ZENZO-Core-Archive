...
void ExpandableButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ExpandableButton::Mouse_Pressed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ExpandableButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ExpandableButton::Mouse_Hover)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ExpandableButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ExpandableButton::Mouse_HoverLeave)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject ExpandableButton::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ExpandableButton.data,
      qt_meta_data_ExpandableButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ExpandableButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ExpandableButton.stringdata0))
        return static_cast<void*>(const_cast< ExpandableButton*>(this));
