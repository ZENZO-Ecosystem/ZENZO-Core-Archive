...
public:
    ...
    void setupUi(QWidget *SettingsDisplayOptionsWidget)
    {
        ...
        horizontalPercentagezPiv->setObjectName(QStringLiteral("horizontalPercentagezPiv"));
        ...
        verticalDenomzPiv = new QSpacerItem(20, 10, QSizePolicy::Minimum, QSizePolicy::Fixed);

        verticalLayout_2->addItem(verticalDenomzPiv);

        horizontalDenomzPiv = new QHBoxLayout();
        horizontalDenomzPiv->setObjectName(QStringLiteral("horizontalDenomzPiv"));
