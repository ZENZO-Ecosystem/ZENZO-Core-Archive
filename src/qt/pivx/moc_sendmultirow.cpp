...
void SendMultiRow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendMultiRow::removeEntry)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SendMultiRow::*_t)(SendMultiRow * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendMultiRow::onContactsClicked)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SendMultiRow::*_t)(SendMultiRow * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendMultiRow::onMenuClicked)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendMultiRow::onValueChanged)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendMultiRow::onUriParsed)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject SendMultiRow::staticMetaObject = {
    { &PWidget::staticMetaObject, qt_meta_stringdata_SendMultiRow.data,
      qt_meta_data_SendMultiRow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SendMultiRow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SendMultiRow.stringdata0))
        return static_cast<void*>(const_cast< SendMultiRow*>(this));
