...
void TooltipMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TooltipMenu::onDeleteClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TooltipMenu::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TooltipMenu::onCopyClicked)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (TooltipMenu::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TooltipMenu::onEditClicked)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject TooltipMenu::staticMetaObject = {
    { &PWidget::staticMetaObject, qt_meta_stringdata_TooltipMenu.data,
      qt_meta_data_TooltipMenu,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TooltipMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TooltipMenu.stringdata0))
        return static_cast<void*>(const_cast< TooltipMenu*>(this));
