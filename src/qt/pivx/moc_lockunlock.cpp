...
void LockUnlock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LockUnlock::Mouse_Entered)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (LockUnlock::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LockUnlock::Mouse_Leave)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LockUnlock::lockClicked)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject LockUnlock::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LockUnlock.data,
      qt_meta_data_LockUnlock,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LockUnlock::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LockUnlock.stringdata0))
        return static_cast<void*>(const_cast< LockUnlock*>(this));
