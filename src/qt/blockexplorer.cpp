...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::ZNZ, nValue);
...
{
    std::string genesisblockhash = "0000024c78d7d2fb56363f7777bab06de80307ac751b02e843ca7ae62d2310d2";
