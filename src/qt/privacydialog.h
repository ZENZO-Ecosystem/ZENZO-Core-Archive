...
public:
    ...
    void setZZNZControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzZNZ_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzZNZ_clicked();
    void on_pushButtonZZNZControl_clicked();
