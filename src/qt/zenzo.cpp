...
{
    return QCoreApplication::translate("zenzo-core", psz).toStdString();
}
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. ZENZO can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
